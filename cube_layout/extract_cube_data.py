"""Run SUMO via TraCI and extract per-edge traffic metrics to CSV.

Usage: ensure SUMO and the TraCI Python package are installed and in PATH,
then run `python extract_cube_data.py` from the folder containing the SUMO files.
"""
import logging
import sys
import traci
